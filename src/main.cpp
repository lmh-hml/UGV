                          ...
                          MIN_DIST(40), MAX_DIST(90),MIN_SIDES(50)
{
	...
	US_listener=nh.subscribe<ugv::Int16Array>("ultrasonicArray",10, &JoyControl::SonicCallBack,this);
...
void JoyControl::dynamicReconfig(ugv::ControlDistConfig &config, uint32_t level )
{
...
void JoyControl::SonicCallBack( const ugv::Int16Array::ConstPtr& ary) //this collects info from front sensors
{
